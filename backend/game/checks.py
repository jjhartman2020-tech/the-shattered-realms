...
def resolve_check(
    *,
    ...
    """Roll and resolve one mechanical check.

    Natural 1 is always a disaster/failure and natural 20 is always a critical
    success. Otherwise the modified total is compared with the DC.
    """
    if dc is None:
    ...
    total = int(base["total"]) + int(modifier)
